...
gear_codes <- c("SHELLFISH POT (CRAB)","CRAB OR LOBSTER POT","CRAB POT","CRAB RING","TROLL, (SALMON)") # ,"OCEAN TROLL","TROLL (SALMON)","DRAG SEINE","DIP BAG NET","HOOK AND LINE","PURSE SEINE (SALMON)")
...
alltime <- proc.time()
process_year <- 2014 # year of data to process
first_process_year <- 2014 # first year of data available - if process_year > first_process_year, then lookback at the end of the prior year for tickets and VMS pings in step 4
```
