...
ggsave(filename = here::here("Confidential", "figures", "map_unadjusted_pings.png"), 
       plot = map_log_pings_dcrb_year_month_5km_df,
       width = 10, height = 5)
...
map_log_pings_dcrb_year_month_5km_df_adjusted <- ggplot() +
  ...
  theme_minimal()
map_log_pings_dcrb_year_month_5km_df_adjusted
ggsave(filename = here("Confidential", "figures", "map_trip_adjusted_pings.png"), 
       plot = map_log_pings_dcrb_year_month_5km_df_adjusted,
       width = 10, height = 5)
...
# avg. ping rate boxplot for before and after ping rate increase
