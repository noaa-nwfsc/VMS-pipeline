...
dcrb_vms_tix_analysis <- vms_all_grd_match %>%
  ...
  # TODO confirm ok to remove DEPTH_CATM and NGDC_M filters?
  mutate(
    ...
    crab_year = ifelse(month_as_numeric >= 11, paste0(year, "_", 1+year), paste0(year-1, "_", year)) # crab season starts in Nov.
  ) %>%
  dplyr::select(
...
# TODO visualize distribution of these 4 new variables
