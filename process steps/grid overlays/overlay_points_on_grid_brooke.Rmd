...
Now filter the data based on control variables below: California, depth <= 150m, slow vessel speeds.

Also add date columns and select subset of features from dataset.
