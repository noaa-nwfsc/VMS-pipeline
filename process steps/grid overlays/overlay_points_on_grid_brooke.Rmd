...
summary(baseline_2017_2019$avg_DCRB_VMS_pings_adjusted)
summary(baseline_2017_2019$avg_normalized_adjusted_DCRB_VMS_pings)
# write output
...
# visualize all years (adjusted ping rate)
# join summary back to geometry by GRID5KM_ID
dcrb_year_month_5km_df_with_grid <- dcrb_year_month_5km_df %>% 
  left_join(grd, by = join_by(GRID5KM_ID)) %>%
  st_as_sf()
