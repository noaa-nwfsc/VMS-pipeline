...
vms_all_grd_match %>% 
  ...
  write_rds(here('Confidential', 'processed', 'pipeline output', 'DCRB and CHNK 28May2024', 'vms_all_w_grd_5km.rds'))
# TODO rename output
```

## Prep data for DCRB focused analysis

Ok now that we have the VMS data on the 5km grid, we need to prepare it for analysis as in Samhouri et al. 2021 PRSB, with a focus on DCRB fishing effort.
...
vms_all_grd_match <- read_rds(here('Confidential', 'processed', 'pipeline output', 'DCRB and CHNK 28May2024', 'vms_all_w_grd_5km.rds'))
...
con_df_daily_years_5km <- dcrb_vms_tix_analysis_TripInfo %>%
...
glimpse(con_df_daily_years_5km)

### if and when satisfied, write out rds

write_rds(con_df_daily_years_5km,here::here('Confidential', 'processed', 'pipeline output', 'DCRB and CHNK 28May2024', 'DCRB_vms_tix_daily_2009_2023_lbs_rev_per_5kmgrid_nodepthfilter.rds'))
