...
# TODO should I be using dcrb_vessels_per_vms_record instead of n_unique_vessels for vessel map?
...
representativeness_monthly_table <- dcrb_ticket_df %>%
  ...
  summarise(
    ...
    # repeat for revenue
    vms_represented_revenue          = sum(vms_represented_flag * DCRB_revenue),
...
# write monthly result
write.csv(file = here("Confidential", "tables", "table_vms_representativeness_monthly.csv"),
...
# write yearly result
write.csv(file = here("Confidential", "tables", "table_vms_representativeness_yearly.csv"),
...
ggsave(filename=here("Confidential", "figures", "time_series_representativeness_yearly.png"))
...
vms_representativeness_time_series_monthly <- representativeness_monthly_table %>%
  ...
  geom_col() +
  facet_grid(metric ~ ., scales = "free_y")
ggsave(filename=here("Confidential", "figures", "time_series_representativeness_monthly.png"))
...
# write monthly result
write.csv(file = here("Confidential", "tables", "table_vms_representativeness_monthly_stratified.csv"),
...
# write yearly result
write.csv(file = here("Confidential", "tables", "table_vms_representativeness_yearly_stratified.csv"),
...
stratified_vms_representativeness_time_series_yearly <- stratified_representativeness_yearly_table %>%
  ...
  xlab("year") +
  facet_grid(metric ~ ., scales = "free_y")
ggsave(filename=here("Confidential", "figures", "time_series_representativeness_yearly_stratified.png"))
...
stratified_vms_representativeness_time_series_monthly <- stratified_representativeness_monthly_table %>%
  ...
  geom_col(position = "dodge") +
  facet_grid(metric ~ ., scales = "free_y")
ggsave(filename=here("Confidential", "figures", "time_series_representativeness_monthly_stratified.png"))
...
Create maps of fishing activity, based on the # of VMS pings and # of unique vessels in the gridded summary. This is one of the slowest parts of the script.
...
fishing_activity_map <- function (data_sf, data_col, bbox, log_transform, fill_range, title, data_col_name, png_suffix='', background_sf) {
  ...
  # save the output map
  ggsave(filename=here("Confidential", "maps", paste0(data_col_name, "_", png_suffix, ".png")))
...
fishing_activity_gif(map_directory = here("Confidential", "maps"), map_metric_name = "n_vms_records")
fishing_activity_gif(map_directory = here("Confidential", "maps"), map_metric_name = "n_unique_vessels")
```
