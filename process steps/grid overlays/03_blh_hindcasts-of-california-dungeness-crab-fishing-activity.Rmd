...
```{r vms-representativeness}
# TODO move this higher up in script
# - load data before generating outputs
# - generate plots before confidentiality stats
# TODO test for multiple years of data

# load fish ticket data, before joined to VMS pings
...
# apply same filters as VMS pings, except for depth and speed which are from VMS
...
# TODO combine with transformation step, don't do separately
# add column to ticket dataframe for whether that ticket was represented by VMS data
dcrb_ticket_df <- left_join(dcrb_ticket_df, dcrb_vms_rec_ids, by = join_by(Rec_ID)) %>%
