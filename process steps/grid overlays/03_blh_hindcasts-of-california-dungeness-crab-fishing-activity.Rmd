...
time_series_df %>% ggplot() + geom_col(aes(x = year_month, y = dcrb_vessels, fill = crab_year))
...
time_series_df %>% ggplot() + geom_tile(aes(x = month, y = as.factor(year), fill = dcrb_vessels))
