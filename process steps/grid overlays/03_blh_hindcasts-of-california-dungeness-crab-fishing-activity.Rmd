...
create_log10_map <- function (data_sf, data_col, data_col_name, png_suffix='', background_sf) {
  # set bounding box
...
# make map
map_output <- create_log10_map(data_sf=dcrb_5km_summary_confidential_sf,
                               data_col=dcrb_5km_summary_confidential_sf$n_vms_records,
