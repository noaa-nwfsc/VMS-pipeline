...
n_drop_confidential <- sum(dcrb_5km_summary_sf$n_vms_records) - sum(dcrb_5km_summary_confidential_sf$n_vms_records)
# denominator: # of records, without any confidentiality filter
n_no_drop_confidential <- sum(dcrb_5km_summary_sf$n_vms_records)
