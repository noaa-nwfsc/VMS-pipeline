...
rawdat <- read_rds(here::here('Confidential','raw','fish_tickets','all_fishtickets_1994_2023.rds'))
rawdat <- rawdat %>%
...
for(y in 1:length(yrs_of_data)) {
 dat_out %>% 
    ...
    write_rds(here::here('Confidential','processed','fish_tickets',paste0(yrs_of_data[y],"fishtix_withFTID",".rds",collapse=""))) 
}
