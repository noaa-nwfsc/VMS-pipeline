...
```{r data}
vms <- read_rds(here::here('data','processed','matched','matching',paste0(process_year,'matched_vmstix_only_withFTID.rds')))
```
...
```{r}
portlist_coords <- read_csv(here::here('data','raw','port_coords.csv'),col_types='cddd') %>% 
...
write_rds(vms_filtered,here::here('data','processed','matched','filtering',paste0(process_year,'matched_filtered_withFTID_length.rds')))
