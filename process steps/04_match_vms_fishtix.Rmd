...
fishtix <- read_rds(here::here('Confidential','processed','fish_tickets',paste0(process_year,'fishtix_vlengths_withFTID.rds')))
...
if(process_year > first_process_year){
  fishtix_prev <- read_rds(here::here('Confidential','processed','fish_tickets',paste0(process_year-1,'fishtix_withFTID.rds'))) %>% 
