...
fishtix <- read_rds(here::here('Confidential','data','processed','fish_tickets',paste0(process_year,'fishtix_vlengths_withFTID.rds')))
...
if(process_year > first_process_year){
  fishtix_prev <- read_rds(here::here('Confidential','data','processed','fish_tickets',paste0(process_year-1,'fishtix_withFTID.rds'))) %>% 
...
```{r load vms}
vms <- read_rds(here::here('Confidential','data','processed','vms',paste0(process_year,'_vms_clean.rds')))

if(process_year > first_process_year){
  vms_prev <- read_rds(here::here('Confidential','data','processed','vms',paste0(process_year-1,'_vms_clean.rds'))) %>% 
...
write_rds(fishtix_vms_all,here::here('Confidential','data','processed','matched','matching',paste0(process_year,'_matched_alltix_withFTID.rds')))
write_rds(fishtix_vms_only,here::here('Confidential','data','processed','matched','matching',paste0(process_year,'_matched_vmstix_only_withFTID.rds')))
```
