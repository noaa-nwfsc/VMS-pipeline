...
For species code options, see https://pacfin.psmfc.org/pacfin_pub/data_rpts_pub/code_lists/sp.txt. 

For gear code options, see https://pacfin.psmfc.org/pacfin_pub/data_rpts_pub/code_lists/agency_gears.txt. Use the full names rather than abbreviations (i.e., the "AGENCY DESCRIPTION" column of the linked table, e.g. "CRAB POT", not "CPT").
...
gear_codes <- c("FISH TRAP", "FISH POT", "BOTTOMFISH POT", "TRAPS, SEATTLE TYPE (SABLEFISH)") # sablefish pot
```
