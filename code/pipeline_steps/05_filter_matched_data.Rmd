...
```{r data}
vms <- read_rds(here::here('Confidential', 'data', output_dir_name, 'matched', paste0('matched_vmstix_only_withFTID_', process_year, '.rds')))
```
...
output_subdir <- here('Confidential','data', output_dir_name, 'filtered')
if (!dir.exists(output_subdir)) dir.create(output_subdir)

#Save version with FTID and length
write_rds(vms_filtered,here::here('Confidential', 'data', output_dir_name, 'filtered', paste0('matched_filtered_withFTID_length_', process_year, '.rds')))
write_rds(vms_wfilters,here::here('Confidential', 'data', output_dir_name, 'filtered', paste0('matched_unfiltered_', process_year, '.rds')))
```
