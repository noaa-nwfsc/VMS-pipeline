...
```{r rawdat}
vms_filtered <- read_rds(here::here('Confidential', 'data', output_dir_name, 'filtered', paste0('matched_filtered_withFTID_length_', process_year, '.rds')))
```
...
output_subdir <- here('Confidential','data', output_dir_name, 'interpolated')
if (!dir.exists(output_subdir)) dir.create(output_subdir)

# write output
write_rds(vms_regular, here::here('Confidential','data', output_dir_name, 'interpolated', paste0('interpolated_', process_year, '.rds')))
```
