...
```{r rawdat}
vms_filtered <- read_rds(here::here('Confidential','data','processed','matched','filtering',paste0(process_year,'_matched_filtered_withFTID_length.rds')))
```
...
# write output
write_rds(vms_regular, here::here('Confidential','data','processed','matched','interpolation',paste0(process_year,'_interpolated.rds')))
```
