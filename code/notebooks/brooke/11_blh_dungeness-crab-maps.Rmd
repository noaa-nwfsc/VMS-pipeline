...
```{r fishing-activity-map-function}
...
map_bbox <- st_bbox(dcrb_5km_monthly_sf)
...
# iterate over months
for (ym in year_month_vector[1:24]) {
  ...
  vms_map <- fishing_map(
    ...
    png_name = here("Confidential", "hindcast_output",  output_subdir_name, "maps", paste0("log_10_n_vms_records_", ym, ".png"))
  )
}
```
