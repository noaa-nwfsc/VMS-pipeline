...
fred_pcepi <- read.csv(file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "inflation_pcepi.csv")) %>%
...
if (confidential_flag) {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_monthly_confidential_df.csv"),
    x = dcrb_5km_monthly_df, 
    row.names = FALSE
  )
} else {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_monthly_nonconfidential_df.csv"),
    x = dcrb_5km_monthly_df, 
    row.names = FALSE
  )
}
...
if (confidential_flag) {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_persistence_simple_confidential_df.csv"),
    x = dcrb_5km_persistence_simple_df, 
    row.names = FALSE
  )
} else {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_persistence_simple_nonconfidential_df.csv"),
    x = dcrb_5km_persistence_simple_df, 
    row.names = FALSE
  )
}
...
if (confidential_flag) {
  png_name = here(output_subdir, "maps_confidential", "persistence", "all", paste0("simple_persistence_all_time.png"))
} else {
  png_name = here(output_subdir, "maps_nonconfidential", "persistence", "all", paste0("simple_persistence_all_time.png"))
}
...
if (confidential_flag) {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_persistence_ranked_interim_confidential_df.csv"),
    x = dcrb_5km_persistence_ranked_interim_df, 
    row.names = FALSE
  )
} else {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_persistence_ranked_interim_nonconfidential_df.csv"),
    x = dcrb_5km_persistence_ranked_interim_df, 
    row.names = FALSE
  )
}
...
if (confidential_flag) {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_persistence_ranked_confidential_df.csv"),
    x = dcrb_5km_persistence_ranked_df, 
    row.names = FALSE
  )
} else {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_persistence_ranked_nonconfidential_df.csv"),
    x = dcrb_5km_persistence_ranked_df, 
    row.names = FALSE
  )
}
...
# set map directory name, specifying whether output is confidential
if (confidential_flag) {
  png_name = here(output_subdir, "maps_confidential", "persistence", "all", paste0("ranked_persistence_all_time_", persistence_threshold * 100, ".png"))
} else {
  png_name = here(output_subdir, "maps_nonconfidential", "persistence", "all", paste0("ranked_persistence_all_time_", persistence_threshold * 100, ".png"))
}
...
# set map directory name, specifying whether output is confidential
if (confidential_flag) {
  map_subdir = here(output_subdir, "maps_confidential", "monthly", "all")
} else {
  map_subdir = here(output_subdir, "maps_nonconfidential", "monthly", "all")
}
...
if (confidential_flag) {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_persistence_ranked_interim_state_confidential_df.csv"),
    x = dcrb_5km_persistence_ranked_interim_state_df, 
    row.names = FALSE
  )
} else {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_persistence_ranked_interim_state_nonconfidential_df.csv"),
    x = dcrb_5km_persistence_ranked_interim_state_df, 
    row.names = FALSE
  )
}
...
if (confidential_flag) {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_persistence_ranked_state_confidential_df.csv"),
    x = dcrb_5km_persistence_ranked_state_df, 
    row.names = FALSE
  )
} else {
  write.csv(
    file = here("Confidential", "hindcast_output", output_subdir_name, "tables", "dcrb_5km_persistence_ranked_state_nonconfidential_df.csv"),
    x = dcrb_5km_persistence_ranked_state_df, 
    row.names = FALSE
  )
}
...
# set map directory name, specifying whether output is confidential
if (confidential_flag) {
  map_subdir = here(output_subdir, "maps_confidential", "persistence")
} else {
  map_subdir = here(output_subdir, "maps_nonconfidential", "persistence")
}
...
# set map directory name, specifying whether output is confidential
if (confidential_flag) {
  map_subdir = here(output_subdir, "maps_confidential", "monthly")
} else {
  map_subdir = here(output_subdir, "maps_nonconfidential", "monthly")
}
...
write.csv(file = here("Confidential", "hindcast_output", output_subdir_name, "map_log.csv"), x = log_df, row.names = FALSE)
```
