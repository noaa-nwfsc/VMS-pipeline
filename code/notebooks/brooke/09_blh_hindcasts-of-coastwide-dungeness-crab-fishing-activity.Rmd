...
ggsave(filename = here("Confidential", "hindcast_output", output_subdir_name, "figures", "time_series_n_vms_records.png"))
...
ggsave(filename = here("Confidential", "hindcast_output", output_subdir_name, "figures", "time_series_n_unique_vessels.png"))

# plot # unique vessels per month as bar chart
time_series_df %>% ggplot() +  geom_col(aes(x = year_month, y = DCRB_lbs, fill = crab_year))
ggsave(filename = here("Confidential", "hindcast_output", output_subdir_name, "figures", "time_series_DCRB_lbs.png"))

# plot # unique vessels per month as bar chart
time_series_df %>% ggplot() +  geom_col(aes(x = year_month, y = DCRB_revenue_afi, fill = crab_year))
ggsave(filename = here("Confidential", "hindcast_output", output_subdir_name, "figures", "time_series_DCRB_revenue_afi.png"))
