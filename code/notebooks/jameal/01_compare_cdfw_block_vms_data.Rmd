...
dcrb_ticket_df <- ticket_df %>%
  ...
  left_join(
    ...
    by = join_by(Rec_ID == FISH_TICKET_ID, FTID == FTID, date == date, drvid == VESSEL_NUM, agency_code == AGENCY_CODE) # even after adding all of these additional specifications, still get a warning on many to many relationship in 2011 (row 3 of x, row 1223140 of y). but 2021-2022 are fine.
    )
