...
ticket_df2 <- purrr::map(load_years, function(ly) {
  read.csv(here('Confidential', 'raw_data', 'fish_tickets', paste0('fish_tickets_', ly, '.csv')))
}) %>% bind_rows() # 06-11-2025 changed from read_csv to read.csv to avoid warning messages associated with the HILLE_PERMIT column in at least the 2013 data file
