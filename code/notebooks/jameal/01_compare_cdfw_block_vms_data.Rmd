...
Filters derived from define-filters-ticket_df chunk above
...
dcrb_df <- vms_grid10_df %>%
  ...
  distinct(
    VMS_RECNO, Rec_ID, FTID, pacfin_port_code, port_group_code, dealerID, drvid, agency_code, date, TARGET_lbs, all_species_lbs, DCRB_lbs, DCRB_lbs_no_revenue, TARGET_rev, all_species_rev, DCRB_revenue, species_code_all, NGDC_M, X_COORD, Y_COORD,  westcoastdate_notime, avg_speed_recalc, BLOCK10_ID, feature_id, EEZ, State, Salish_Sea, Area_m2, BLOCK10_n,
     .keep_all = TRUE
  ) %>%
  # add temporal columns
  mutate(
